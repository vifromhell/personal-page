...
- Case-study illustrations with dedicated dark variants use `<picture>` sources keyed to `prefers-color-scheme`; mobile dark art direction takes precedence below 768 px.
